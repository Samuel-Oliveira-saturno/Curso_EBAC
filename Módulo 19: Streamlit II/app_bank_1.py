...
def main():
    st.set_page_config(
        ...
        page_icon="/home/sos/Documentos/EBAC_Data_ Scientist/Módulo 19: Streamlit II/telem.jpg",
        layout="wide",
        initial_sidebar_state="expanded",
    )

    # SIDEBAR
    image = Image.open(fp='/home/sos/Documentos/EBAC_Data_ Scientist/Módulo 19: Streamlit II/bank.jpg')
...
## Discente: Samuel Saturno
    ...
    bank_raw = load_data(
        file_data='/home/sos/Documentos/EBAC_Data_ Scientist/Módulo 19: Streamlit II/bank-additional-full.csv', sep=';')
    bank = bank_raw.copy()
